"""
analysis/fairness_benchmark.py
------------------------------
...
stratified sampling against a labelled external corpus.
    ...
    python -m analysis.fairness_benchmark --corpus <dir-of-parquet> --per-group 500
    python -m analysis.fairness_benchmark --corpus <dir> --per-group 500 --json out.json
...
# The project root -- one level up, because this file lives in analysis/.
