"""
cli/face_attendance.py
----------------------
Single-command front end for the whole pipeline.

    python -m cli.face_attendance register "Jane Doe"
    python -m cli.face_attendance train
    python -m cli.face_attendance attendance
    python -m cli.face_attendance report
