...
Usage
-----
    python tools/benchmark_loop.py                    # until stopped
    python tools/benchmark_loop.py --rounds 5         # five rounds
    python tools/benchmark_loop.py --trials 200       # per identity per round
"""
...
def main():
    ...
    if not gallery:
        print("Nobody is enrolled. Run `python -m cli.seed_demo` first.")
        return 1
